...
// Extraemos cada parte manualmente
$pos1 = strpos($ip, ".");
...
// Mostrar con printf
printf("La IP %s en binario es: %s.%s.%s.%s", $ip, $bin1, $bin2, $bin3, $bin4);

echo "<br>";

printf("La IP %s en binario es: %s.%s.%s.%s", $ip2, $bini1, $bini2, $bini3, $bini4);
